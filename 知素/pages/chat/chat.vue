<template>
	<view>
		<view class="content" @touchstart="hideEmoji">
			<scroll-view class="msg-list" :class="showEmji" scroll-y="true" :scroll-with-animation="scrollAnimation" :scroll-top="scrollTop" :scroll-into-view="scrollToView">
		...
		<view class="input-box" :class="showEmji" @touchmove.stop.prevent="discard">
			...
			<view class="textbox">
				...
				<view class="text-mode"  :class="isVoice?'hidden':''">
					<view class="box">
						<textarea auto-height="true" cursor-spacing=20 :show-confirm-bar="false" v-model="textMsg" id="textMsg" />
					</view>
...
.content{
	...
	.msg-list{
		...
		top: 0;
		bottom: 100upx;
		&.hideEmoji{animation: hideMsg .001s linear both;}
		&.showEmoji{animation: showMsg .001s linear both;}
		.row{
			&:first-child{
				margin-top: 20upx;
			}
